...
class PacketBuilder:
    ...
    async def Notification(message: str) -> bytes:
        return await CreateBanchoPacket(OsuPacketID.Bancho_Announce, (message, osuTypes.string))
    ...
    async def ChannelListeningEnd() -> bytes:
        return await CreateBanchoPacket(OsuPacketID.Bancho_ChannelListingComplete.value)
    ...
    async def MatchJoinFailed() -> bytes:
        return await CreateBanchoPacket(OsuPacketID.Bancho_MatchJoinFail.value)
    ...
    async def MatchHostTransfer() -> bytes:
        return await CreateBanchoPacket(OsuPacketID.Bancho_MatchTransferHost.value)

    # bancho response: 61
    @staticmethod
    async def MultiSkip():
        return await CreateBanchoPacket(OsuPacketID.Bancho_MatchSkip.value)

    # bancho response: 53
    @staticmethod
    async def AllPlayersLoaded():
        return await CreateBanchoPacket(OsuPacketID.Bancho_MatchAllPlayersLoaded.value)
    ...
    async def MatchFinished() -> bytes:
        return await CreateBanchoPacket(OsuPacketID.Bancho_MatchComplete.value)
    ...
    async def BanchoRestarting(ms: int) -> bytes:
        return await CreateBanchoPacket(OsuPacketID.Bancho_Restart, (ms, osuTypes.u_int32))
    ...
    async def UserRestricted() -> bytes:
        return await CreateBanchoPacket(OsuPacketID.Bancho_AccountRestricted.value)
    ...
    @staticmethod
    async def KillPing():
        return await CreateBanchoPacket(OsuPacketID.Bancho_Ping.value, (0, osuTypes.byte))

    # bancho response: 106
    @staticmethod
    async def MatchAborted():
        return await CreateBanchoPacket(OsuPacketID.Client_MatchAbort.value)
